var soundido = document.getElementById("btn-soundido");

soundido.addEventListener("click", function () {
    var videoSonando = document.getElementById("videito-soundido");

    if (videoSonando.muted) {

        videoSonando.muted = false;
        soundido.innerHTML = `                        
        <svg style="height: 40px;" aria-hidden="true" focusable="false" data-prefix="fas"
            data-icon="volume-up" class="svg-inline--fa fa-volume-up fa-w-18" role="img"
