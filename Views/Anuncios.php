            ...
            <div class="navbar-nav ml-auto">
                ...
                <?php if (!empty($user)) : ?>
                    <div class="button-primary mr-3">
                        <a href="./../Views/CrearAnuncio.php" class="bg-transparent text-nowrap text-white text-decoration-none hover-none">Publicar Anuncio</a>
                    </div>
                    ...
                    <div class="card-body row m-0 px-3">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="col-12 row m-0 px-0">
                                ...
                                <span id="rangeval" class="ml-auto mr-0">5000
                                    <!-- Default value -->
                                </span>
