...
<body class="bg-default">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a href="./Contactanos.php" class="nav-item nav-link active text-primary">Contáctanos</a>
            </div>
    ...
    <div class="mapa mt-5 pt-4"> <!---MArgin y padding porque el nav se superpone-->
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3900.6373895808924!2d-86.22629628565328!3d12.136944235926562!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f73fe7867ce5fad%3A0x842c4aeae5cf3cda!2sUniversidad%20Nacional%20de%20Ingenier%C3%ADa%20(RUPAP)!5e0!3m2!1ses!2sni!4v1620357842225!5m2!1ses!2sni"
            height="450" style="border:0;" allowfullscreen="" loading="lazy" class="w-100"></iframe>
    </div>

    <div class="p-5">
        <div class="row m-0"> 
            <div class="col-larg-6 col-mediu-12 mx-auto"> <!---Margin X automatico-->
                <div class="row mx-0 contactanos shadow-default">
                    <div class="px-3">
                        <label class="row mx-0 mb-3 mt-3 bb-black-50 pb-3 text-bold text-center">Envíanos un mensaje</label>
                        <form class=" row mx-0 mt-4">
                            <input class="col-12 form-component" type="text" placeholder="Nombre" maxlength="100" required>
                            <input class="col-12 form-component" type="text" placeholder="Asunto" maxlength="100" required>
                            <input class="col-12 form-component" type="email" placeholder="Correo de contacto" required>
                            <textarea class="col-12 form-component" rows=3 placeholder="¿Que necesita?" minlength="50" required></textarea>
                            <input class="button-primary text-white-90 mx-auto" type="submit" value="Enviar">
                        </form>
                    </div>
                </div>
            </div>
            <!-- <div class="col-larg-6 col-mediu-12 row m-0">
                <div class="col-12">
                    <div class="row m-4 contactanos shadow-default">
                        <label class="w-100 mb-3 bb-black-50 pb-3">Dirección</label>
                        <textarea class="w-100 form-component" readonly>De donde el vecino, al frente del otro lado, por la calle de esa entrada.</textarea>
                    </div>

                </div>
                <div class="col-12">
                    <div class="row m-4 contactanos shadow-default">
                        <label class="w-100 mb-3 bb-black-50 pb-3">Información de contacto</label>
                        <a class="w-100 mb-3 text-black-50 text-decoration-none" href="Tel:+50522222222">Tel: +505 22222222</a>
                        <a class="w-100 mb-3 text-black-50 text-decoration-none" href="mailto:correo@finditnow.com">Email: correo@finditnow.com</a>
                        <a class="w-100 mb-3 text-black-50 text-decoration-none" href="cel:+50588888888">Cel: +505 88888888</a>
                    </div>
                </div>
            </div> -->
        </div>
