...
<body class="bg-default">
                    ...
                    <div class="px-3 py-3">
                        <div class="w-100 card shadow-default">
                            ...
                            <div class="card-body row m-0">
                                ...
                                <input id="title-post" class="form-component w-100 mb-4">
                                <label for="category-post" class="text-black-50 text-bold"><i class="fas fa-shapes mr-2"></i>Categoría</label>
                                <select id="category-post" class="form-component w-100 mb-4">
                                    <option value="">Seleccione</option>
                                    <option value="1">Aparatos electronicos</option>
                                    <option value="2">Bienes Raices</option>
                    ...
                    <div class="px-3 py-3 h-100">
                        <div class="w-100 h-100 card shadow-default">
                            ...
                            <div class="card-body row m-0 pt-2">
                                <textarea id="descript" class="form-component w-100 m-0" placeholder="Breve descripción de la publicación"></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="contenedor-botones" class="row mx-auto">
        <div id="contenedor" class="row d-flex justify-content-center mx-auto pb-3">
            <button id="btn-postear"
                class="button-primary text-white cursor-pointer mx-5 font-weight-bold"><i class="fas fa-upload mr-3"></i>Publicar</button>
            <button id="btn-guardar"
                class="button-save text-white cursor-pointer mx-5 font-weight-bold"><i class="fas fa-save mr-3"></i>Guardar</button>
            <button id="btn-cancelar"
                class="button-cancel text-white cursor-pointer mx-5 font-weight-bold"><i class="fas fa-trash-alt mr-3"></i>Eliminar</button>
        </div>
    </div>
    </div>
