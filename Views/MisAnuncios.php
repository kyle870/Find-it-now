...
<body>
    ...
    <div class="row m-0 mt-5 pt-5">
        <div class="col-12">
            <div class="p-3">
                <div class="card bg-white border-radius-20 shadow-default">
                    <div class="card-title w-100 items-in-row py-3">
                        <h3 class="w-100 text-center text-bold">Todas las Categorías</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mx-0 mb-4">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuCategorias">
                                    ...
                                    <button class="dropdown-item" type="button">Publicados</button>
                                    <button class="dropdown-item" type="button">Inactivos</button>
                        ...
                        <div class="row mx-0 container-table">
    ...
    <div class="container-fluid my-5">
        <h3 class="mb-5 text-black-75 text-center">Calendario de publicaciones de anuncios</h3>
        <div id="calendar"></div>
    </div>
