...
<body class="bg-default ">
                    ...
                    <div class="px-3 py-3 h-100">
                        <div class="w-100 h-100 card shadow-default">
                            <div class="card-title w-100 items-in-row p-3">
                                <label class="w-100 text-center m-auto font-18 text-bold">Jonissa María Alfaro Carrión</label>
                            </div>
                            <div id="cardBodyProfile" class="card-body row m-0 px-3">
                                ...
                                <div class="row m-0 col-lg-4 col-md-6 col-sm-12 ">
                                    <div id="container-profile" class="container px-0 ">
                                        <div id="wrapper-profile" class="wrapper w-100 h-100 "> <!---Elementos para subir la imagen-->
                    ...
                    <div class="px-3 py-3 h-100">
                        <div class="w-100 h-100 card shadow-default">
                            ...
                            <div class="card-body row m-0 px-3">
                                ...
                                <form class="row col-12 m-0">
                                    <div class="card-title w-100 items-in-row py-3">
                                        <label class="w-100 text-center m-auto font-18 text-bold">Administración de contraseña</label>
                                    </div>
                                    <div class="claseContrasena col-lg-6 col-md-6 col-sm-12 m-0">
                                        <label for="inpContrasena" class="text-black-50 text-bold"><i class="fas fa-key mr-2"></i>Contraseña</label>
                                        <input id="inpContrasena" type="password" class="form-component w-100 mb-4">
                                    </div>
                                    <div class="nuevaContrasena col-lg-6 col-md-6 col-sm-12 m-0">
                                        <label for="inpNuevaContrasena" class="text-black-50 text-bold"><i class="fas fa-key mr-2"></i>Nueva Contraseña</label>
                                        <input id="inpNuevaContrasena" type="password" class="form-component w-100 mb-4">
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <div id="contenedor-botones" class="row mx-auto">
        <div id="contenedor" class="row d-flex justify-content-center mx-auto pb-3">
            <button id="btn-editar-perfil" class="button-primary text-white cursor-pointer mx-5 font-weight-bold px-4"><i class="fas fa-user-edit mr-3"></i>Editar</button>
            ...
            <button id="btn-deshacer-perfil" class="button-cancel text-white cursor-pointer mx-5 font-weight-bold"><i class="fas fa-redo mr-3"></i>Deshacer</button>
        </div>
    </div>
    </div>
            ...
            <div class="p-5 row footer ">
                <div class="col-extlarg-4 col-mediu-6 col-peque-12 row m-0 mb-3 ">
                    <div class="col-12 row m-0 ">
                        <img class="mx-0 logo " src="./../Resources/LogoGrande.png " title="Find-It-Now" />
                    </div>
