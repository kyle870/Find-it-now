...
require_once './../controllers/editarAnuncioController.php';
...
<head>
    ...
    <title>Editar Anuncio | <?php echo $datosAnuncio->titulo; ?></title>
</head>
...
<body class="bg-default">
    ...
    <div class="p-3 mt-5 pt-5">
        <form id="frmCrearAnuncio" action="./../Views/editarAnuncio.php?id=<?php echo $datosAnuncio->id_ad ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                        ...
                        <div class="px-3 py-3">
                            <div class="w-100 card shadow-default">
                                ...
                                <div class="card-body row m-0">
                                    ...
                                    <input id="title-post" name="inpPostAnuncioTitulo" class="form-component w-100 mb-4" value="<?php echo $datosAnuncio->titulo; ?>">
                                    ...
                                    <select id="category-post" name="selPostAnuncioCategoria" class="form-component w-100 mb-4">
                                        <option value="<?php echo $datosAnuncio->categoria; ?>"><?php echo $datosAnuncio->categoria; ?></option>
                                    ...
                                    <input id="precio-post" name="inpPostAnuncioPrecio" class="form-component w-100 mb-4" type="text" value="<?php echo $datosAnuncio->precio; ?>">
                                    <label for="inpDisponible" class="text-black-50 text-bold"><i class="fas fa-balance-scale mr-2"></i>Cantidad disponible</label>
                                    <input id="inpDisponible" name="inpPostAnuncioCantidad" class="form-component w-100 mb-4" type="text" value="<?php echo $datosAnuncio->cantidad; ?>">
                                    ...
                                    <select id="inpCondition" name="selPostAnuncioCondicion" class="form-component w-100 mb-4">
                                        <option value="<?php echo $datosAnuncio->condicion; ?>"><?php echo $datosAnuncio->condicion; ?></option>
                                    ...
                                    <div class="claseDepartamento">
                                        ...
                                        <select id="selectorAnuncioDepartamento" name="selPostAnuncioUbicacion" class="form-component w-100 mb-4">
                                            <option value="<?php echo $datosAnuncio->ubicacion; ?>"><?php echo $datosAnuncio->ubicacion; ?></option>
                        ...
                        <div class="px-3 py-3">
                            <div class="w-100 card shadow-default">
                                ...
                                <div class="card-body row m-0 px-3">
                                    <div id="image-announcement" class="image w-75 mx-auto p-2 ">
                                        <img class="img-thumbnail h-100" id="previewImg" src="<?php echo $datosAnuncio->fotos; ?>">
                                    </div>
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label text-truncate" for="customFile"><i class="fas fa-cloud-upload-alt mx-2"></i>Cambiar imagen para tu anuncio</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="px-3 py-3 h-100">
                            <div class="w-100 h-100 card shadow-default">
                                ...
                                <div class="card-body row m-0 pt-2">
                                    <textarea id="descript" name="inpPostAnuncioDesc" class="form-component w-100 m-0" rows="5" placeholder="Breve descripción de la publicación" style="resize: none;" value="<?php echo $datosAnuncio->descricion; ?>"><?php echo $datosAnuncio->descricion; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="contenedor-botones" class="row mx-auto">
                <div id="contenedor" class="row d-flex justify-content-center mx-auto pb-3">
                    <input type="hidden" name="inpIdAnuncio" value="<?php echo $datosAnuncio->id_ad; ?>">
                    <button id="btn-postear" type="submit" value="Submit" class="button-primary text-white cursor-pointer mx-5 font-weight-bold"><i class="fas fa-upload mr-3"></i>Actualizar</button>
                    <button id="btn-cancelar" type="reset" class="button-cancel text-white cursor-pointer mx-5 font-weight-bold"><i class="fas fa-trash-alt mr-3"></i><a href="./MisAnuncios.php" class="text-white text-decoration-none">Regresar</a></button>
                </div>
            </div>
        </form>
    </div>
